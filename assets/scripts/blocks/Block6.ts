...
export class Block6 extends Block {
    normalState(): void {
        ...
        this.stopAllTweens();
        this.sprites[0].spriteFrame = this.spriteFrames[15];
        this.sprites[1].spriteFrame = this.spriteFrames[7];
        this.sprites[2].spriteFrame = this.spriteFrames[8];
        this.sprites[3].spriteFrame = this.spriteFrames[13];
        this.sprites[4].spriteFrame = this.spriteFrames[13];
    ...
    excitedState(): void {
        ...
        this.sprites[2].spriteFrame = this.spriteFrames[6];
        this.sprites[3].spriteFrame = this.spriteFrames[13];
        this.sprites[4].spriteFrame = this.spriteFrames[13];
        this.startTweenForSprites();
    }
    sleepyState(): void {
        ...
        this.stopAllTweens();
        this.sprites[0].spriteFrame = this.spriteFrames[15];
        this.sprites[1].spriteFrame = this.spriteFrames[12];
        this.sprites[2].spriteFrame = this.spriteFrames[14];
        this.sprites[3].spriteFrame = this.spriteFrames[13];
        this.sprites[4].spriteFrame = this.spriteFrames[13];
        this.startTweenForSprites();
    }
    ...
    deathState(): void {
        ...
        this.stopAllTweens();
        this.sprites[0].spriteFrame = this.spriteFrames[16];
        this.sprites[1].spriteFrame = this.spriteFrames[7];
        this.sprites[2].spriteFrame = this.spriteFrames[8];
        this.sprites[3].spriteFrame = this.spriteFrames[13];
        this.sprites[4].spriteFrame = this.spriteFrames[13];
